<template>
    <AppModal 
        ...
        :pending="pending.projectsActifs" 
        :submit-btn="true" 
        :cancel-btn="true"
    ...
    >
        ...
        <div v-else class="list-group list-group-flush">
            <div v-for="projet in projetsActifs" :key="'projet-'+projet.id" class="list-group-item">       
                ...
                <div class="form-check text-nowrap">
                    <div class="text-secondary"><i class="fbi bi-calendar-fill"></i> {{projet.ddp}} <i class="bi bi-chevron-right"></i> {{projet.dfp}}</div>
                </div>
            </div>
        </div>
    </AppModal>
...
export default {
    ...
    methods: {
        ...
        loadRessourcesProjetRoute() {
            ...
            this.$router.push({name:"RessourcesProjet", params: {projetListId: sProjetListId}})
        },
